...
class InAppPurchaseHandler: NSObject {
    ...
    //MARK:- Shared Object
    //MARK:-
    static let sharedInstance = InAppPurchaseHandler()
    ...
    func purchase(product: SKProduct, completion: @escaping ((InAppPurchaseHandlerAlertType, SKProduct?, SKPaymentTransaction?)->Void)) {
        ...
        if self.canMakePurchases() {
            ...
            completion(InAppPurchaseHandlerAlertType.disabled, nil, nil)
        }
    }
...
extension InAppPurchaseHandler: SKProductsRequestDelegate, SKPaymentTransactionObserver{
    ...
    func productsRequest (_ request:SKProductsRequest, didReceive response:SKProductsResponse) {
        log("RESPONSE PRODUCT: \(response.products)")
