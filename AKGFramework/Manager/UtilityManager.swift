...
class UtilityManager {
    ...
    func getBaseAppColor() -> UIColor {
        return UIColor.init(red: 70.0/255.0, green: 168.0/255.0, blue: 173.0/255.0, alpha: 1.0)
    }
    ...
    func deviceIdentifier() -> String {
        ...
        print("DEVICE ID FROM KEYCHAIN: \(String(describing: deviceId))")
    ...
    func requestDeviceIdentifierFromKeychain() -> String {
        let dictionary : [String: Any] = [kSecClass as String : kSecClassGenericPassword,
                                          kSecAttrService as String : "akggames",
                                          kSecAttrAccount as String : "akggames",
